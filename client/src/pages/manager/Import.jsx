...
export default function ManagerImport() {
  ...
  return (
    <Layout title="Import Products" navItems={managerNavItems}>
      <div className="max-w-2xl mx-auto">
        ...
        <div className="mt-6 bg-yellow-50 border border-yellow-200 rounded-lg p-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="font-medium text-yellow-900">Catalog Import Only</h3>
              <p className="text-sm text-yellow-700 mt-1">
                This import creates <strong>product catalog entries only</strong>. Inventory quantities start at 0.
                Inventory is only created when items are physically received at the warehouse via the Receive Inventory process.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-6 bg-blue-50 rounded-lg p-4">
          ...
          <ul className="text-sm text-blue-700 space-y-1">
            <li>- Excel file should have columns: SKU, UPC/EAN, Title, ASIN, FNSKU (optional)</li>
            <li>- You can include an Image URL column to provide listing photos</li>
